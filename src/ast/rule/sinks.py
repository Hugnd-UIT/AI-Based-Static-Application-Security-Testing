SINKS = [
    ...
    # PHP
    "system", "popen", "shell_exec", "eval", "passthru", "preg_replace", "create_function",
    ...
    # C#
    "SqlCommand", "ExecuteScalar", "ExecuteSqlRaw", "ExecuteSqlCommand", "FromSqlRaw",
    "Process.Start", "ProcessStartInfo", "BinaryFormatter", "Response.Write", "Response.Redirect",
    "Redirect", "WebClient", "HttpClient", "DirectorySearcher", "XmlDocument",
